...
export const translations = {
  en: {
    ...
    tab_prof: 'Professions',
    prof_title: 'AI Profession Types',
    prof_add: 'Add Profession',
    prof_edit: 'Edit Profession',
    prof_name: 'Profession Name',
    prof_desc: 'Description',
    prof_prompt: 'System Prompt Instructions',
    prof_save: 'Save Profession',
    prof_empty: 'No professions found.',
    prof_delete_confirm: 'Are you sure you want to delete this profession?',
    
    ws_tab_tasks: 'Task View',
    ws_tab_info: 'Project Info',
    info_title: 'Project Information Base',
    info_add: 'Add Information',
    info_name: 'Name',
    info_content: 'Content',
    info_target: 'Target Profession',
    info_all: 'All Professions',
    info_delete_confirm: 'Delete this information card?',
  },
  zh: {
    nav_projects: '项目大厅',
    nav_employees: 'AI员工',
    ...
    tab_global: '全局设置',
    tab_prof: '职业管理',
    prof_title: 'AI 职业类型列表',
    prof_add: '添加职业',
    prof_edit: '编辑职业',
    prof_name: '职业名称',
    prof_desc: '职业描述',
    prof_prompt: '系统提示词/指令',
    prof_save: '保存职业',
    prof_empty: '暂无职业类型',
    prof_delete_confirm: '确认删除此职业类型吗？',
    ...
    info_target: '查看职业',
    info_all: '所有职业',
    info_delete_confirm: '确定要删除这条信息吗？',
  }
};
